...
export const AuthModal: React.FC<AuthModalProps> = ({ onLoginSuccess }) => {
  ...
  return (
    <div className="min-h-screen bg-shtab-dark flex items-center justify-center p-4">
      <div className="bg-shtab-sidebar border border-slate-700 w-full max-w-md rounded-2xl p-8 shadow-2xl text-slate-100">
        <div className="flex flex-col items-center mb-8">
          {/* 
            ...
            Line: ~41
            Tag: <img src="/logo.svg" alt="Shtab Logo" className="w-12 h-12 text-shtab-accent mb-3" />
            Path to image: public/logo.svg (or public/logo.png)
            ========================================================================
          */}
          <div className="w-14 h-14 bg-shtab-accent rounded-xl flex items-center justify-center shadow-lg mb-3">
            <img src="/logo.svg" alt="Shtab Logo" className="w-8 h-8 text-white" onError={(e)=>{
              // Fallback inline SVG if logo.svg is missing
        ...
        <div className="mt-8 pt-6 border-t border-slate-800 text-xs text-slate-500 text-center">
          Default Admin Login: <span className="text-slate-400">admin@shtab.local</span> / <span className="text-slate-400">admin123</span>
        </div>
      </div>
    </div>
  );
